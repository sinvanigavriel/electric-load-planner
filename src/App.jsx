...
export default function App() {
  ...
  return (
    <div dir="rtl" className="fixed inset-0 flex flex-col overflow-hidden bg-zinc-100 font-body text-zinc-900">
      ...
      <div className="shrink-0 border-t-2 border-zinc-900 bg-white px-4 pb-[calc(min(env(safe-area-inset-bottom),34px)+0.5rem)] pt-2">
        <button
          onClick={() => {
            setTargetPhase(null);
      ...
      {showAddModal && (
        <div className="fixed inset-x-0 bottom-0 z-30 flex items-end justify-center" style={{ top: headerHeight }}>
          ...
          <div className="relative flex max-h-full w-full max-w-md flex-col overflow-hidden rounded-t-3xl bg-zinc-100 shadow-2xl">
            ...
            <div className="shrink-0 border-t-2 border-zinc-900 bg-white px-4 pb-[calc(min(env(safe-area-inset-bottom),34px)+1rem)] pt-2">
